...
def main():
    ...
    parser.add_argument("--prompt_override", type=str, default=None,
                        help="If set, use this string as the prompt for ALL conditions instead of the original template")
    ...
    args.output_dir = os.path.join(args.output_dir, f"{args.task_suite_name}_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
